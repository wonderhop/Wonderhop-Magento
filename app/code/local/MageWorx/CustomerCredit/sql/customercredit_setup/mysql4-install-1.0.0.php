...
CREATE TABLE IF NOT EXISTS {$this->getTable('customercredit_credit')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('customercredit_credit_log')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('customercredit_code')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('customercredit_code_log')} (
  `log_id` int(10) unsigned NOT NULL auto_increment,
